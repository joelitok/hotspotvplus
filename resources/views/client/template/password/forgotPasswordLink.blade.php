...
<main class="login-form">
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Réinitialisé votre mots de passe</div>
                    <div class="card-body">
                        ...
                        <form action="{{ url('/admin/reset-password')}}" method="POST">
                            ...
                            <div class="form-group row">
                                <label for="password-confirm" class="col-md-4 col-form-label text-md-right">Confirmer le mots de passe</label>
                                <div class="col-md-6">
